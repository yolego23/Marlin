...
#define STRING_CONFIG_H_AUTHOR "(IGTREETECH, MPMD)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Mini Delta"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.39,  13.39 }
    #define DEFAULT_Ki_LIST {   0.72,   0.72 }
    #define DEFAULT_Kd_LIST {  61.99,  61.99 }
  #else
...
#define DELTA
  ...
  #define DELTA_HEIGHT 130             // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT,  97.00  }  // default steps per unit for PowerWasp
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0.0, 0.0, 0.4 }
...
#define Z_PROBE_SPEED_FAST 5000
